...
if (export_plots_to_plots_folder) {
  plotname=file.path(plot_dir,"S5b_SelectedBetaModelVariables.pdf") #Comment to SIP 
...
mtext("Selected Beta Model Variables",side=3,outer = TRUE,line=3)
